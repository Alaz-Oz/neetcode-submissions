    ...
    public int minEatingSpeed(int[] piles, int h) {
        ...
        while(min_rate <= max_rate){
            ...
            for(int i = 0; i < piles.length; i++){
                ...
                // if (totalHours > h) continue outer;
            }
            ...
            if (totalHours > h){
                ...
                result = cur_rate;
            // } else {
            //     // This could be min if lesser don't exist
        ...
        // outer: for(int cur_rate = min_rate; cur_rate <= max_rate; cur_rate++){
        //     int totalHours = 0;
        //     for(int i = 0; i < piles.length; i++){
        //         int cur_pile = piles[i];
        //         int hoursTaken = (int) Math.ceil((float)cur_pile / cur_rate);
        //         totalHours += hoursTaken;
        //         if (totalHours > h) continue outer;
        //     }
